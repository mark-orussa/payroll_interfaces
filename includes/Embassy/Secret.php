...
class Secret {
	...
	public function __construct($keyPath) {
		...
		$Debug->newFile('includes/Embassy/Secrets.php');
		try{
			// Read the key file.
	...
	public function decrypt($cipherString, $key = false) {
		...
		try{
			...
			CustomException::setMessages('','Wrong key or modified cipher text when trying to decrypt.',$this->Message, $this->Debug);
