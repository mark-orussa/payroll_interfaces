...
$Page->addBody('
    ...
    <p><a class="makeButtonInline" href="index.php"><i class="fa fa-arrow-right fa-rotate-180"></i>Return to Payroll Interfaces</a></p>
        ...
        <span style="font-weight:bold">Step 3:</span>' . $SlstartCentralReachToAdp->buildIframe() . $SlstartCentralReachToAdp->getInvalidData() . $SlstartCentralReachToAdp->getDuplicateEntries() . $SlstartCentralReachToAdp->getOverlappingEntries() . $SlstartCentralReachToAdp->getUnrecognizedJobCodes());
echo $Page;
